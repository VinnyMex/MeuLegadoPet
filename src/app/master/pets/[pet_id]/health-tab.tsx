...
import { masterAddVaccine, masterAddMedication, masterAddCondition, masterAddAllergy } from './actions-forms'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border-sky-100 shadow-sm">
          ...
          <CardContent className="pt-4">
            <form action={masterAddVaccine.bind(null, petId)} className="flex flex-col gap-3 mb-6">
        ...
        <Card className="border-emerald-100 shadow-sm">
          ...
          <CardContent className="pt-4">
            <form action={masterAddMedication.bind(null, petId)} className="flex flex-col gap-3 mb-6">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
        ...
        <Card className="border-indigo-100 shadow-sm md:col-span-2">
          ...
          <CardContent className="pt-4">
            <form action={masterAddCondition.bind(null, petId)} className="flex flex-col md:flex-row items-end gap-3 mb-6">
        ...
        <Card className="border-red-100 shadow-sm md:col-span-2">
          ...
          <CardContent className="pt-4">
            <form action={masterAddAllergy.bind(null, petId)} className="flex flex-col md:flex-row items-end gap-3 mb-6">
              <div className="space-y-1 flex-1 w-full">
